...
**🎉 v1 is complete** — every phase above is implemented and verified end-to-end against a real Alpine/musl sandbox, and phase 8 proves the whole premise with a real Claude agent under a true air-gap. Remaining `polish` + `sandbox_id` fleet-namespacing verification is incremental.
